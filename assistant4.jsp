...
<body>
<%
String points12=request.getParameter("points12"); 
%>
<body>
...
DriverManager.getConnection("jdbc:mysql://localhost:3306/elidek", "root", "Appl3pass");
 ...
 ResultSet resultset2 = statement.executeQuery("SELECT * FROM Project WHERE Start_Date>'2000-01-01' AND Start_Date<'2022-05-01' AND End_Date>'2000-01-01' AND End_Date<'2022-05-01' or Executive_Executive_ID IN (SELECT Executive_ID FROM Executive WHERE Name='Smith') or Duration<"+points12+"");
%>
<H1>Projects that have duration smaller than the one you typed:</H1>
<TABLE BORDER="1">
 <TR>
 <TH>Project ID</TH>
 <TH>Project Title</TH>
